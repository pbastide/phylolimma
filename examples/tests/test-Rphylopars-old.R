...
#
#   ## Transform again
#   tree_ou_error <- phylolm::transf.branch.lengths(tree_rep_per, "OUfixedRoot", parameters = list(alpha = fit_ou$optpar,
...
#
#   ## Variances
#   # expect_equivalent(fit_bm2$sigma2, fit_bm$sigma2, tolerance = 1e-4)
#
#   ##############################################################################
#   ### delta - lambda transform
#
#   ## delta
#   fit_delta <- phylolm::phylolm(trait ~ 1, traits, tree_rep_per,
#                                 model = "delta", upper.bound = list(delta = 5),
