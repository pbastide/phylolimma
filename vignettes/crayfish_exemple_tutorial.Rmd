...
Computations can be made in parallel with argument `ncores`.
Here, for the sake of rapidity, we only analyse the first 500 genes.
...
(Here, keep in mind that because we only analysed the first 500 genes, the results
cannot to be interpreted directly.)
