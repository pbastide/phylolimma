...
The goal of this script is to detect genes with a significant parallel shift 
in optimum between blind species versus sighted species (one of the hypothesis presented in the 
Table from Stern & Crandal (2018)[^1] ).
...
cannot be interpreted directly, and some plots might look different when
