...
to the results, possibly with a trend.
...
(Here, because we only analysed the first 500 genes, the results
cannot to be interpreted directly.)

## Parameters of the OU

`phyloDE` fits a OU process per gene, and then regularize the parameters
